...
export class EditorShell extends Entity {
  ...
  private applyLayout(): void {
    ...
    const showZoomReadout = this.width >= 760;
    this.zoomOutTool.setFrame(Math.max(408, this.width - (showZoomReadout ? 276 : 196)), 12, false);
    this.zoomReadout.setFrame(this.width - 180, 12, showZoomReadout, this.camera.state.zoom);
    this.zoomInTool.setFrame(Math.max(504, this.width - 100), 12, false);
